        ...
        <div className="p-[40px] w-[60vw]">
          <div>
            <h2 className="font-bold p-[40px]">
              The destination that you've selected is : <span className="text-yellow-500">{props.place.place}</span>
            </h2>
          </div>
          <div>
            <h2 className="font-bold p-[40px]">
              Train : <span className="text-yellow-500">{ props.train.train_name}</span>
            </h2>
          </div>
        </div>
        <img

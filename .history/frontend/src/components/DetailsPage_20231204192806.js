...
function IterinaryShower({ item, planName }) {
  return (
    <div className="bg-white p-[30px] w-[20vw]">
      ...
      <div className="flex flex-row justify-center">
        <span className="bg-black text-white px-[15px] py-[10px] m-[10px] cursor-pointer">
          Select
        </span>
      </div>
    </div>
        ...
        {iterinaries === null ? (
          ...
          <div className="flex flex-row justify-evenly">
            ...
            <IterinaryShower
              ...
              planName={"Extended"}
            />
            <IterinaryShower item={iterinaries.plan.quick} planName={"Quick"} />
          </div>
        )}
      </div>
      <Footer></Footer>

    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route
          path="/bookings"
          element={
            <Hotels place={place} user={user} train={train} iterinary={iterinary} setHotel={setHotel} hotel={hotel}></Hotels>
          }
        ></Route>
        <Route
          path="/transport"
          element={
            <Trains place={place} user={user} setTrain={setTrain} train={train}></Trains>
          }
        ></Route>
      </Routes>
    </BrowserRouter>
